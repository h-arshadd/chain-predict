...
try:
    save_execution_config(
        ...
        exchange="bybit",
        symbol="btc",
        strategy_name="RSI_14_reversal",

        # Only used on the very first run (no saved state yet) -- after
        # that, execution.positions' last_processed takes over. Set to
        # roughly "now" since live execution has no history to backfill.
