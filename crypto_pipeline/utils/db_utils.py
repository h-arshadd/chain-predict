...
class DatabaseManager:
    """
    Manages PostgreSQL connections and all database operations for the pipeline.
    Handles schema/table creation, candle insertion, and incremental timestamp checks.
    """
    ...
    def create_tables(self, conn, exchange: str, symbols: list, timeframes: list):
        """
    ...
    def get_last_timestamp(self, conn, exchange: str, symbol: str, timeframe: str):
        """
    ...
    def insert_candles(self, conn, exchange: str, symbol: str, timeframe: str, df):
        """
...
def create_tables(conn, exchange, symbols, timeframes):
    return _db_manager.create_tables(conn, exchange, symbols, timeframes)

def get_last_timestamp(conn, exchange, symbol, timeframe):
    return _db_manager.get_last_timestamp(conn, exchange, symbol, timeframe)

def insert_candles(conn, exchange, symbol, timeframe, df):
    return _db_manager.insert_candles(conn, exchange, symbol, timeframe, df)
