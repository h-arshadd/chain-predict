        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
            <Panel title="Equity Curve">
              <EquityCurveChart series={equitySeries} gradientId="btEqGrad" emptyText="Not enough data to plot an equity curve." />
            </Panel>
            <Panel title="Drawdown">
              <DrawdownChart series={drawdownSeries} gradientId="btDdGrad" emptyText={data.stats ? 'No drawdown periods.' : 'Not enough trade history for stats.'} />
            </Panel>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
            <Panel title="Rolling Sharpe">
              <RollingSharpeChart series={rollingSharpeSeries} emptyText="Not enough history for a rolling Sharpe window." />
            </Panel>
            <Panel title="Rolling Volatility">
              <RollingVolatilityChart series={rollingVolSeries} emptyText="Not enough history for rolling volatility." />
            </Panel>
          </div>
