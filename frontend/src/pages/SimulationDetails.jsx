    ...
    <div style={{ paddingTop: 8 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
        <Panel title="Equity Curve">
          <EquityCurveChart
            series={equitySeries}
            gradientId="simEqGrad"
            centered
            emptyText="Not enough closed simulator trades yet to plot an equity curve."
          />
        </Panel>
        <Panel title="Drawdown">
          <DrawdownChart
            series={drawdownSeries}
            gradientId="simDdGrad"
            centered
            emptyText={data.stats ? 'No drawdown periods yet.' : 'Not enough trade history for stats yet.'}
          />
        </Panel>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
        <Panel title="Rolling Sharpe">
          <RollingSharpeChart series={rollingSharpeSeries} centered emptyText="Not enough history for a rolling Sharpe window yet." />
        </Panel>
        <Panel title="Rolling Volatility">
          <RollingVolatilityChart series={rollingVolSeries} centered emptyText="Not enough history for rolling volatility yet." />
        </Panel>
      </div>
